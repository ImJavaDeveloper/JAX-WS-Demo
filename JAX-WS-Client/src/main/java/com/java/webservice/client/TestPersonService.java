...
import com.java.webservice.jaxws.service.Person;
import com.java.webservice.jaxws.service.PersonService;
import com.java.webservice.jaxws.service.PersonServiceImplService;
...
public class TestPersonService {
	...
	public static void main(String[] args) {
		...
		p1.setName("Pankaj"); p1.setId(1); p1.setAge(30);
        Person p2 = new Person(); 
        p2.setName("Meghna"); p2.setId(2); p2.setAge(25);
        
        System.out.println("Add Person Status="+service.addPerson(p1));
        System.out.println("Add Person Status="+service.addPerson(p2));
        
      //get person
        System.out.println(service.getPerson(1).getName());
